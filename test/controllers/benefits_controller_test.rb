...
class BenefitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create benefit" do
    assert_difference('Benefit.count') do
      post benefits_url, params: { benefit: { company_id: @benefit.company_id, description: @benefit.description, title: @benefit.title } }
    end
  ...
  test "should update benefit" do
    patch benefit_url(@benefit), params: { benefit: { company_id: @benefit.company_id, description: @benefit.description, title: @benefit.title } }
